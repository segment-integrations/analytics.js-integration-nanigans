...
<noscript><img style="display: none;" src="//api.nanigans.com/event.php?app_id={{ appId }}&type=visit&name=landing"></noscript>')
...
<noscript><img style="display: none;" src="//api.nanigans.com/event.php?app_id={{ appId }}&type=user&name={{ name }}&user_id={{ userId }}&ut1={{ ut1 }}"></noscript>')
...
<noscript><img style="display: none;" src="//api.nanigans.com/event.php?app_id={{ appId }}&type=user&name=product_view&user_id={{ userId }}&ut1={{ ut1 }}&{{ products }}"></noscript>')
...
<noscript><img style="display: none;" src="//api.nanigans.com/event.php?app_id={{ appId }}&type=user&name=add_to_cart&user_id={{ userId }}&ut1={{ ut1 }}&{{ products }}"></noscript>')
  .tag('purchase', '<script>
  // NaN_api = [[app_id, user_id], [type, name, value, extra]];
  NaN_api = [
    [{{ appId }}, {{ userId }}],
...
<noscript><img style="display: none;" src="//api.nanigans.com/event.php?app_id={{ appId }}&type=purchase&name=main&user_id={{ userId }}&ut1={{ ut1 }}&{{ products }}&unique={{ orderId }}"></noscript>');
